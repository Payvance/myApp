...
public class EmailService {
        ...
        public void sendTrialStartedEmail(String to, java.time.LocalDateTime start, java.time.LocalDateTime end) {
                ...
                // and can cause transaction rollback if desired. Async sends are
                // fire-and-forget
        ...
        private void sendLicenseIssuedEmailInternal(String toEmail, List<String> ccVendorEmail, String plainLicenseKey,
                        boolean sync) {
        ...
        public void sendCaRequestNotifications(String tenantEmail, String tenantName,
                ...
                try {
                        ...
                        Map<String, Object> caVariables = Map.of(
                                        ...
                                        "message",
                                        "A new tenant has requested to connect with you. Please review their request in your dashboard.",
        ...
        public void sendInvoiceEmail(String toEmail, String tenantName, String invoiceNumber, String amount,
                        List<InvoiceItem> items, String gstRate, String gstAmount, String subtotal) {
                ...
                try {
                        ...
                        emailJob.sendEmailWithAttachment(toEmail, "Invoice Generated - " + invoiceNumber, html,
                                        pdfBytes,
                                        "Invoice_" + invoiceNumber + ".pdf", null);
                } catch (java.io.IOException e) {
                        // Fallback to HTML email if PDF fails
                        emailJob.sendHtmlEmail(toEmail, "Invoice Generated - " + invoiceNumber, html, null);
                }
        }

        /**
         * Send an email notification to the super admin when a new contact message is
         * received.
         * This method is triggered after a contact message is successfully saved.
         */
        public void sendContactUsAdminNotificationEmail(ContactUs contact) {
                // Validate that the contact object is not null
                if (contact == null) {
                        throw new IllegalArgumentException("Contact cannot be null");
                }

                // Map used to store dynamic variables that will be injected into the email
                // template
                Map<String, Object> variables = new HashMap<>();

                // subject displayed in the template
                variables.put("subject", "New Contact Us Request: " + contact.getSubject());
                variables.put("title", "New Contact Inquiry");
                variables.put("name", "Super Admin");
                variables.put("message", "A new contact request has been submitted with the following details:");

                // Construct the detailed message containing user information
                String details = "Name: " + contact.getFullName() + "\n" +
                                "Email: " + contact.getEmail() + "\n" +
                                "Phone: " + contact.getPhoneNumber() + "\n" +
                                "Subject: " + contact.getSubject() + "\n" +
                                "Message: " + contact.getMessage();

                variables.put("info", details);

                // Send the email using the universal email sender method
                sendUniversalEmail(
                                "info@payvance.co.in",
                                "New Contact Us Request: " + contact.getSubject(),
                                variables,
                                null);
        }
}
